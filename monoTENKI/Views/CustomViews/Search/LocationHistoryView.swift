...
struct LocationHistoryView: View {
  ...
  @Binding private var locationHistory: [Location]
  @Binding private var editing: Bool

  init(locationHistory: Binding<[Location]>, isEditing: Binding<Bool>) {
  ...
  @ViewBuilder private func createHistoryBlock(for location: Location) -> some View {
    HStack {
      if editing {
        Button {
